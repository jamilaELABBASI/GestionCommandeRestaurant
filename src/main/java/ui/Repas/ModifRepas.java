		...
		import javax.swing.JComboBox;
			...
			public class ModifRepas extends JFrame {
		 ...
		 * @throws Exception 
		 */
		public ModifRepas() throws Exception {
		...
		table_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				 ...
				 int selectedRow=table_1.getSelectedRow();
					...
					S_Mod_Prix.setText(model1.getValueAt(selectedRow, 2).toString());		
					S_Mod_Type.setText(model1.getValueAt(selectedRow, 3).toString());
